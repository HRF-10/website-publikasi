  ...
  <div class="breadcumb-area bg-img bg-gradient-overlay">
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-12">
          <h2 class="title">Bendahara Sekolah</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Respon Aspirasi</li>
              <li class="breadcrumb-item active" aria-current="page">Bendahara Sekolah</li>
            </ol>
          </nav>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="dento-price-table table-responsive">
            <table class="table table-borderless mb-0">
              ...
              <tbody>
                <tr>
                  @foreach($bendahara_data as $data)
                  <tr>
                  <tr>
                    @if($data->id == 1)
                      <td>{{ $data->aspirasi }}</td>
