  ...
  <div class="breadcumb-area bg-img bg-gradient-overlay">
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-12">
          <h2 class="title">ASKADUTA 2023</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="col-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Respon Aspirasi 2023</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <section class="dento-about-us-area section-padding-100-0">
          <div class="container">
              <div class="row align-items-center justify-content-center">
                  <!-- About Content -->
                  <div class="col-12">
                      <div class="about-us-content mb-50 text-center d-flex flex-wrap justify-content-center wow fadeInUp" data-wow-delay="0.7s">
                          <!-- Section Heading -->
                          @foreach ($respons as $key => $respon)
                              <div class="card ml-30 mb-50 @if(!$loop->last) mr-3 @endif" style="width: 18rem;">
                                  <div class="card-body">
